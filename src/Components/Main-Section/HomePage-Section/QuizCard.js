  ...
  return (
    <div className='border-2 rounded-md p-2'>
      ...
      <div className='flex items-center justify-between text-gray-600 mt-2 mb-1'>
        ...
        <Link to={'/quiz'} className='text- bg-[#D4F2F4] rounded-sm font-medium py-1 px-2 flex items-center'>Quiz <ArrowLongRightIcon className="ml-1 h-5 w-5"></ArrowLongRightIcon> </Link>
      </div>
    </div>
  );
};
