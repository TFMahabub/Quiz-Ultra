  ...
  return (
    <nav className='flex items-center justify-between bg-[#F5F8FF] border-b-2 py-4 px-3 md:px-16'>
      ...
      <div className='text-md md:text-xl font-normal md:font-semibold'>
        <NavLink to={'/'} className={'mx-1 md:mx-2 hover:text-[#179AB4]'}>Home</NavLink>
        <NavLink className={'mx-1 md:mx-2 hover:text-[#179AB4]'}>Statiestics</NavLink>
        <NavLink className={'mx-1 md:mx-2 hover:text-[#179AB4]'}>Blog</NavLink>
      </div>
    </nav>
  );
};
